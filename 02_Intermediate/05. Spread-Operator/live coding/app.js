...
// console.log(Math.max(...nums)); // Spreading Each Element into individual arguments
...
// let peoples = ["James", "john", "alex"];
// let friends = ["jordan", "fred", "brad", ...peoples, "john doe"];
// console.log(friends);
...
// const clone = { ...person, work: "Programming", location: "London" };
// console.log(clone);
